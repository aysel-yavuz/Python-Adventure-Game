...
# Description for the player what is happening in the game
def intro():
...
# Different scenarios based on the previous choice in
# case the player meets trick-or-treaters
...
# Different scenarios based on the previous choice
# in case the player meets zombies
...
# Different scenarios based on the previous choice
# in case the player meets vampires
def vampires(item, play_again_list):
    if item == "garlic":
        print_pause("You deterred the vampires with garlic.")
...
def action_2(enemy, item, items_trunk, play_again_list, enemies):
    ...
    print_pause("You put waterguns in your bag and return to the enemy")
...
# the ["candies", "waterguns", "garlic"] list
...
# The player is given a choice of two actions after meeting an enemy to use an
# item against the enemy or to return to the trunk and pick another item.
